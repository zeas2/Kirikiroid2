...
sa = vmull_u8(vorr_u8(s.val[_I], mask1), d.val[_I]);
n = vtst_u8(d.val[_I], mask80); // n = d>=128
d1 = vand_u8(d.val[_I], n), s1 = vand_u8(vand_u8(s.val[_I], n), maskFE);
sa = vshrq_n_u16(sa, 7);
